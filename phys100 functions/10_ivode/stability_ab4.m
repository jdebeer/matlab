function stability_ab4
   tspan      = [1 20];
   h1         = 0.029; h2 = 0.03; h3 = 0.0325;
   n1         = round( (tspan(2) - tspan(1))/h1 );
   n2         = round( (tspan(2) - tspan(1))/h2 );
   n3         = round( (tspan(2) - tspan(1))/h3 );
  
   df_dt      = @(t, u) -5.0*t*u^2 + 5/t -1/t^2;
   [t1, y1]   = ab4(df_dt, [1, 20], 1, n1);
   [t2, y2]   = ab4(df_dt, [1, 20], 1, n2);
   [t3, y3]   = ab4(df_dt, [1, 20], 1, n3);
   ...
   title ('stability\_ab4.m', 'FontSize',16); 