function stability_am4
   tspan      = [1 20];
   h1         = 0.20; h2 = 0.25; h3 = 0.3;
   n1         = round( (tspan(2) - tspan(1))/h1 );
   n2         = round( (tspan(2) - tspan(1))/h2 );
   n3         = round( (tspan(2) - tspan(1))/h3 );
  
   df_dt      = @(t, u) -5.0*t*u^2 + 5/t -1/t^2;
   [t1, y1]   = am4(df_dt, [1, 20], 1, n1);
   [t2, y2]   = am4(df_dt, [1, 20], 1, n2);
   [t3, y3]   = am4(df_dt, [1, 20], 1, n3);
   ...
   title ('stability\_am4.m', 'FontSize',16); 